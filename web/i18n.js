...
export const I18N = {
  en: {
    ...
    minimax: "Mini Max",
    dag: "DAG v1",
    dagv2: "DAG v2 (strongest)",
    ttMemory: "Engine memory (TT)",
    ttAuto: "Auto (fit device)",
  ...
  ru: {
    ...
    minimax: "Mini Max",
    dag: "DAG v1",
    dagv2: "DAG v2 (сильнейший)",
    ttMemory: "Память движка (TT)",
    ttAuto: "Авто (по устройству)",
    deviceDetected: "Устройство",
    deviceCores: "ядер",
  ...
  kk: {
    ...
    minimax: "Mini Max",
    dag: "DAG v1",
    dagv2: "DAG v2 (ең күшті)",
    ttMemory: "Қозғалтқыш жады (TT)",
    ttAuto: "Авто (құрылғыға сай)",
    deviceDetected: "Құрылғы",
    deviceCores: "ядро",
  ...
  ky: {
    ...
    minimax: "Mini Max",
    dag: "DAG v1",
    dagv2: "DAG v2 (эң күчтүү)",
    ttMemory: "Кыймылдаткыч эси (TT)",
    ttAuto: "Авто (түзмөккө жараша)",
    deviceDetected: "Түзмөк",
    deviceCores: "ядро",
