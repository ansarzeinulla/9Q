...
TEST(EvaluationTest, BasicHeuristicEvaluation) {
    ...
    // At initial balanced position with P1's turn and P1's perspective, the score has a +10.0 tempo bonus.
    ...
    // If P1 has stones in Kazan, evaluation from P1's perspective should be positive and greater than initial.
